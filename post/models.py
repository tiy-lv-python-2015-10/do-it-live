...
class Post(models.Model):
    ...
    favorite_users = models.ManyToManyField(User, through='Favorite', related_name='favorite_posts')
    date_added = models.DateTimeField(auto_now_add=True)
    date_modified = models.DateTimeField(auto_now=True)

    def __str__(self):
        return "title: {}, Description: {}, price: {}, user_email: {}, phone_number: {}, zipcode: {}," \
                " images: {}, date_added: {}, favorite_users: {}, date_modified: {}".format(self.title,
                                                                                            self.description,
                                                                                            self.price,
                                                                                            self.user_email,
                                                                                            self.phone_number,
